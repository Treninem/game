...
def load_source() -> Image.Image:
    encoded = "".join(_encoded_source().split())
...
def main() -> None:
    ...
    display = image.resize((512, 512), Image.Resampling.LANCZOS)
    display.save(PNG_OUT, format="PNG", optimize=True)
    ...
    print(f"Wrote ImPuls branding from selected artwork: {PNG_OUT}")
